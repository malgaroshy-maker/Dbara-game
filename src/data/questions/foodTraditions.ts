...
export const foodTraditionsQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 3,
    funFact: 'المثرودة من أطباق الكرم في شرق ليبيا، يُفتَّت فيها خبز التنور ويُمزج بالزبدة المذابة والحليب، وقد يُضاف إليها التمر.',
    rewardDinars: 40,
    source: 'ويكيبيديا العربية (مقال: مثرودة)',
    needsReview:
      'الوصف الشرقي (خبز تنور بالزبدة والحليب) موثق، لكن الاسم قد يُستعمل في مناطق أخرى لطبق مالح بالمرق. إن كان الاستعمال عندك مختلفاً فأخبرني.',
  },
  {
    id: 'food_trad_11',
    category: 'food_traditions',
