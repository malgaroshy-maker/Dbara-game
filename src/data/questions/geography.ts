...
export const geographyQuestions: TriviaQuestion[] = [
  ...
  // ── مدن ومحطات الخريطة ───────────────────────────────────────────────────
  {
    ...
    options: ['التباوية', 'الأمازيغية', 'الطوارقية', 'الإيطالية'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['جبل نفوسة', 'واحات جالو والكفرة', 'الجبل الأخضر', 'ساحل زوارة'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['مصب نهر كبير', 'مرفأ طبيعي عميق ومحمي', 'جزيرة مواجهة للمدينة', 'شلالات ساحلية'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['أوباري', 'الشاطئ', 'مرزق', 'براك'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['تازربو', 'الجوف', 'ربيانة', 'بزيمة'],
    correctIndex: 1,
