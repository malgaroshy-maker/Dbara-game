...
export const sportsQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    rewardDinars: 40,
    needsReview:
      'ما زال بلا توثيق. مراجعة آلية بالبحث ادّعت تأكيده وأحالت إلى مقالة النادي في ويكيبيديا العربية، لكن المقالة لا تذكر اللقب إطلاقاً — فالادعاء ساقط لا مؤيَّد. يحتاج تأكيد من متابع للكرة الليبية. ويرد اللقب أيضاً في عبارة سباق السرعة sb_22.',
  },
  {
    id: 'spo_08',
    category: 'sports',
