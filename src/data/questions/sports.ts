...
export const sportsQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    rewardDinars: 40,
    needsReview:
      'عراقة النادي وألقابه مؤكدة، أما لقب «الفحامة» فمتداول بين الجماهير ولم أجد له توثيقاً — يحتاج تأكيد من متابع للكرة الليبية. ويرد اللقب أيضاً في عبارة سباق السرعة sb_22.',
  },
  {
    id: 'spo_08',
    category: 'sports',
