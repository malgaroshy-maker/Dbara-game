...
export const historyQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    options: ['رأس الرمل', 'رأس أجدير', 'رأس التين', 'رأس الهلال'],
    correctIndex: 0,
    funFact: 'يشكل رأس الرمل معلماً ملاحياً مهماً على المتوسط، ويجاوره ميناء قصر أحمد التجاري.',
    rewardDinars: 40,
    needsReview:
      'ميناء قصر أحمد بمصراتة مؤكد، أما تسمية اللسان الرملي والمنارة بـ«رأس الرمل» فلم أتمكن من تأكيدها من مصدر موثوق — يحتاج تأكيد أهل المدينة.',
  },
  {
    id: 'hist_nal_01',
    category: 'history',
