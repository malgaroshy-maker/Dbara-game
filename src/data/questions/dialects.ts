...
export const dialectQuestions: TriviaQuestion[] = [
  {
    ...
    options: ['الجو حار جداً', 'الجو بارد جداً', 'الجو ممطر', 'الجو مغبر'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['قليل ونادر', 'سريع', 'كثير جداً', 'متأخر'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['متعب', 'حسناً وجيد', 'غالي الثمن', 'بعيد'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['أرغب', 'أستطيع', 'أتذكر', 'أعرف'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['يخسرك', 'يسألك', 'يعذرك', 'يجهلك'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['أسرع في المشي', 'انتبه واحذر', 'اذهب للنوم', 'تكلم بصوت عالٍ'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['قصّ شواربه', 'أطعمه عسل', 'فتّله حبل', 'علمه الصبر'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['السوق', 'البيت والدار', 'الحديقة العامة', 'المدرسة'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['تبني دار', 'تصفق', 'تحمل حملين', 'تكتب'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['بالتأكيد', 'يا ترى / هل', 'أبداً', 'ربما لاحقاً'],
    correctIndex: 1,
