...
export const generalArabQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    rewardDinars: 50,
    needsReview:
      'موقع الحقل وكونه من الكبرى مؤكد، لكن «الأكثر إنتاجاً» رقم يتغير بحسب الظروف التشغيلية والإغلاقات — يفضَّل تثبيته على مصدر رسمي من المؤسسة الوطنية للنفط أو إعادة صياغته بلا تفضيل.',
  },
  {
    id: 'gen_40',
    category: 'general_arab',
