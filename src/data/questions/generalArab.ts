...
export const generalArabQuestions: TriviaQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    funFact: 'حقل الشرارة في حوض مرزق جنوب غرب ليبيا هو أكبر الحقول النفطية إنتاجاً في البلاد، وتتجاوز طاقته ثلاثمئة ألف برميل يومياً.',
    rewardDinars: 50,
    needsReview:
      'موقع الحقل وكونه من الكبرى مؤكد، لكن «الأكثر إنتاجاً» رقم يتغير بحسب الظروف التشغيلية والإغلاقات. مراجعة آلية أكّدته دون أن تفتح أي مصدر، فلا يُعتد بها. يحتاج رقماً من المؤسسة الوطنية للنفط، أو إعادة صياغة إلى «الأكبر طاقةً إنتاجية» وهي أثبت من الإنتاج الفعلي.',
  },
  {
    id: 'gen_40',
    category: 'general_arab',
