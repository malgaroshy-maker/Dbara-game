...
import { X, Volume2, VolumeX, Download, Upload, RotateCcw, BarChart2, ShieldCheck } from 'lucide-react';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  const { audio, toggleSound, stats, exportSaveData, importSaveData, resetAllProgress } = useGameStore();
  ...
  const handleImport = () => {
    ...
    const success = importSaveData(importText.trim());
    if (success) {
      setImportStatus('تم استيراد بيانات الحفظ بنجاح! 🎉');
      setTimeout(() => {
          ...
          <div className="p-4 rounded-2xl bg-[#131C2E] border border-white/5 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <span>{exportCopied ? 'تم النسخ للحافظة! ✓' : 'تصدير الحفظ'}</span>
              </button>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <span>استيراد واستعادة الحفظ</span>
              </button>
              {importStatus && (
